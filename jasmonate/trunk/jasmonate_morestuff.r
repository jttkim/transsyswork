...
profilePlotEps("testjfullblank_grad_correlation_logratio_tfhypplus_r50_profiles", unlist(jGeneGroup));
profilePlotEps("testjfullprg_grad_squaresum_logratio_tfhypplus_r50_profiles", unlist(jGeneGroup));
profilePlotEps("testjfullprg_grad_correlation_tfhypplus_r50_profiles", unlist(jGeneGroup));
profilePlotEps("testjfullprg_grad_squaresum_tfhypplus_r50_profiles", unlist(jGeneGroup));

...
do_run ./transsysrewire -w 13 -n test_candidate -r 1 -s 3 test_targettopology.tra
do_run ./transsysrewire -w 66 -n test_candidate -r 1 -s 3 test_targettopology.tra

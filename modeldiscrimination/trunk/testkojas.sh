...
do_run ./transsyswritesimsetOF -o jasmonate_model_v1.txt -s 2 -N 0 jasmonate.tra test_target dummy.txt
...
#do_run ./netopt -x test_target_expr.txt -o modeldisdummy.txt -R 5 -g optspec.dat -T transformerfile.dat -s 1 -c test_candidate_w04_r01.tra t1.tzxt t2.txt
